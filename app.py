...
# ✅ Fixed: Convert to Path object
DATASET_PATH = Path(r"D:\Nipu(imp)\e\datasets")
...
dataset_sentences = [
    ...
    "আপুনি কি ভাবিছে", "আপুনি কিয় কান্দিছে", "আপুনি কিয় খং কৰিছে", "আপুনি কোন",
    ...
    "তোমাৰ লগত কথা পাতি ভাল লাগিল", "নমস্কাৰ", "নমস্কাৰ, আপোনাৰ কি খবৰ", "মই আপোনাক সহায় কৰিব পাৰো নে",
